    ...
    <v-responsive class="align-centerfill-height mx-auto" max-width="900">
      <v-row>
        <v-col md="4" class="d-flex flex-column">
          <div>
            <v-img :src="nft.image" class="image"></v-img>
          </div>
          <v-btn class="mt-5" color="#08f" @click="openTransfer = true">Transfer</v-btn>
        </v-col>
        <v-col md="8" class="d-flex flex-column ga-2 position-relative">
          <div class="token-id">#{{ nft.tokenId }} {{ nft.name }}</div>
          ...
          >
            ...
            <div v-for="attr in nft.attributes" class="attribute">
